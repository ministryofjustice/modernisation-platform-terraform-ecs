...
| <a name="input_disable_ecs_non_prod_scaling"></a> [disable\_ecs\_non\_prod\_scaling](#input\_disable\_ecs\_non\_prod\_scaling) | Set to true if you would like to disable scaling down in the evenings of your test environments | `bool` | `false` | no |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | The full name of the VPC (including environment) used to create resources | `string` | n/a | yes |
